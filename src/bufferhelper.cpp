                              ...
                              size_t &len)
{
    ...
    {
        EXCEPTION_ASSERT(isalnum(in[i]) || (in[i] == '+') || (in[i] == '/') ||
                             ((i >= 2) && (in[i] == '=')),
                         Exception::exception, (std::string("Unexpected character '") +
                                                static_cast<char>(in[i]) + "'")
                                                   .c_str());
    }
...
void BufferHelper::setUShort(std::vector<unsigned char> &buffer,
...
unsigned short BufferHelper::getUShort(const std::vector<unsigned char> &buffer,
                                       size_t &offset)
{
...
void BufferHelper::setUInt32(std::vector<unsigned char> &buffer,
...
unsigned long BufferHelper::getUInt32(const std::vector<unsigned char> &buffer,
                                      size_t &offset)
{
...
void BufferHelper::setUInt64(std::vector<unsigned char> &buffer,
