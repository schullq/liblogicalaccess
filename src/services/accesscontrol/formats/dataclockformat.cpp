...
size_t DataClockFormat::getFormatLinearData(void * /*data*/,
...
void DataClockFormat::getLinearData(void *data, size_t dataLengthBytes) const
{
    ...
    if (data != NULL)
    {
        ...
        pos = 34;
        BitHelper::writeToBit(data, dataLengthBytes, &pos,
                              getRightParity3(data, dataLengthBytes), 7, 1);
        pos = 35;
        BitHelper::writeToBit(data, dataLengthBytes, &pos,
                              getRightParity4(data, dataLengthBytes), 7, 1);
    }
}
...
unsigned char DataClockFormat::getRightParity(const void *data, size_t dataLengthBytes,
                                              ParityType type, unsigned int *positions,
                                              size_t positionLength) const
{
    unsigned char parity = 0x00;

    if (data != NULL)
    {
        parity = Format::calculateParity(data, dataLengthBytes, type, positions,
                                         positionLength);
    }
...
unsigned char DataClockFormat::getRightParity1(const void *data,
                                               size_t dataLengthBytes) const
{
...
unsigned char DataClockFormat::getRightParity2(const void *data,
                                               size_t dataLengthBytes) const
{
    unsigned int positions[8];
    positions[0] = 1;
...
unsigned char DataClockFormat::getRightParity3(const void *data,
                                               size_t dataLengthBytes) const
{
    unsigned int positions[8];
    positions[0] = 2;
...
unsigned char DataClockFormat::getRightParity4(const void *data,
                                               size_t dataLengthBytes) const
{
    unsigned int positions[8];
    positions[0] = 3;
