...
void Wiegand34WithFacilityFormat::getLinearDataWithoutParity(void *data,
...
void Wiegand34WithFacilityFormat::setLinearDataWithoutParity(const void *data,
...
size_t Wiegand34WithFacilityFormat::getFormatLinearData(void *data,
                                                        size_t dataLengthBytes) const
{
