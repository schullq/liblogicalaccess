...
void Wiegand37WithFacilityFormat::getLinearDataWithoutParity(void *data,
...
void Wiegand37WithFacilityFormat::setLinearDataWithoutParity(const void *data,
...
size_t Wiegand37WithFacilityFormat::getFormatLinearData(void *data,
                                                        size_t dataLengthBytes) const
{
...
bool Wiegand37WithFacilityFormat::checkSkeleton(std::shared_ptr<Format> format) const
{
    ...
    if (format)
    {
        std::shared_ptr<Wiegand37WithFacilityFormat> pFormat =
