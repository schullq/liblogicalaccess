...
class LIBLOGICALACCESS_API DataType : public Encoding
{
  public:
     ...
     */
    virtual unsigned int convert(unsigned long long data, unsigned int dataLengthBits,
                                 void *dataConverted,
                                 size_t dataConvertedLengthBytes) = 0;
     ...
     */
    virtual unsigned long long revert(void *data, size_t dataLengthBytes,
     ...
     */
    static unsigned int addParityToBuffer(ParityType leftParity, ParityType rightParity,
     ...
     */
    static unsigned int removeParityToBuffer(ParityType leftParity,
