...
class LIBLOGICALACCESS_API BitHelper
{
  public:
    ...
    /**
     * \brief Revert line of "data" buffer in "revertedData" with new size
     * (revertedDataLength)
     ...
     */
    static unsigned int truncateLittleEndian(void *truncatedData,
     ...
     * \param readLengthBits Length to extract from "data" starting at "readPosBits"
     * offset (in bits)
     ...
     * \param writePosBits Offset in "writtenData" buffer you want to start to write (in
     * bits)
