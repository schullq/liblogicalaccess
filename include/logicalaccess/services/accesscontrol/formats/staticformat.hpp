...
class LIBLOGICALACCESS_API StaticFormat : public Format
{
  public:
     ...
     * \return The parity.
     */
    static unsigned char calculateParity(const void *data, size_t dataLengthBytes,
     ...
     */
    void convertField(void *data, size_t dataLengthBytes, unsigned int *pos,
     ...
     */
    unsigned long long revertField(const void *data, size_t dataLengthBytes,
