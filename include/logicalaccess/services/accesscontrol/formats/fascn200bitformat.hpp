...
class LIBLOGICALACCESS_API FASCN200BitFormat : public StaticFormat
{
  ...
  protected:
    ...
    {
        /**
         * \brief The agency code. Identifies the government agency issuing the
         * credential.
         */
        unsigned short d_agencyCode;

        /**
         * \brief The system code. Identifies the system the card is enrolled in and is
         * unique for each site.
         */
        unsigned short d_systemCode;

        /**
         * \brief The credential series. Field is available to reflect major system
         * changes.
         */
        unsigned char d_serieCode;

        /**
         * \brief The individual credential issue. Initially encoded as '1', will be
         * incremented if a card is replaced due to loss or damage.
         */
        unsigned char d_credentialCode;

        /**
         * \brief The person identifier. Numeric code used by the identity source to
         * uniquely identify the token carrier.
         */
