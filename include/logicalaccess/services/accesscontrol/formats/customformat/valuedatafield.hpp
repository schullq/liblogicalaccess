...
class LIBLOGICALACCESS_API ValueDataField : public DataField
{
  public:
     ...
     */
    void convertNumericData(void *data, size_t dataLengthBytes, unsigned int *pos,
     ...
     */
    void convertBinaryData(const void *data, size_t dataLengthBytes, unsigned int *pos,
                           unsigned int fieldlen, void *convertedData,
     ...
     */
    unsigned long long revertNumericData(const void *data, size_t dataLengthBytes,
                                         unsigned int *pos, unsigned int fieldlen) const;
     ...
     */
    void revertBinaryData(const void *data, size_t dataLengthBytes, unsigned int *pos,
                          unsigned int fieldlen, void *revertedData,
