...
class LIBLOGICALACCESS_API DataTransport : public XmlSerializable
{
  public:
    ...
    sendCommand(const std::vector<unsigned char> &command, long int timeout = 2000);

    /**
     * \brief Get the last command.
     * \return The last command.
     */
    virtual std::vector<unsigned char> getLastCommand()
    {
     ...
     */
    virtual std::vector<unsigned char> getLastResult()
    {
        return d_lastResult;
    };
