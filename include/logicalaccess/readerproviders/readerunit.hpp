                                        ...
                                        public std::enable_shared_from_this<ReaderUnit>
{
  public:
    ...
    */
     ...
     */
    virtual bool waitInsertion(const std::vector<unsigned char> &identifier,
     ...
     */
    inline std::string getCardType() const
    {
        return d_card_type;
    };
     ...
     * \return The chip.
     */
    virtual std::shared_ptr<Chip>
    createChip(std::string type, const std::vector<unsigned char> &identifier);
    ...
    getNumber(std::shared_ptr<Chip> chip,
