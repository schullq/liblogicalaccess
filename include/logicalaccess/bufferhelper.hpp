...
class LIBLOGICALACCESS_API BufferHelper
{
  public:
    ...
    static void setUShort(std::vector<unsigned char> &buffer,
                          const unsigned short &value);

    static unsigned short getUShort(const std::vector<unsigned char> &buffer,
                                    size_t &offset);
    ...
    static unsigned long getUInt32(const std::vector<unsigned char> &buffer,
                                   size_t &offset);

    static void setUInt32(std::vector<unsigned char> &buffer, const unsigned long &value);

    static void setUInt64(std::vector<unsigned char> &buffer,
