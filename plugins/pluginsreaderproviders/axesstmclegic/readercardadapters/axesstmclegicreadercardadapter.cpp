...
AxessTMCLegicReaderCardAdapter::adaptCommand(const std::vector<unsigned char> &command)
{
    return command;
}

std::vector<unsigned char>
AxessTMCLegicReaderCardAdapter::adaptAnswer(const std::vector<unsigned char> &answer)
{
