...
getTwicISO7816Commands(std::shared_ptr<logicalaccess::Commands> *commands)
{
    if (commands != NULL)
    {
        *commands = std::shared_ptr<logicalaccess::TwicISO7816Commands>(
            new logicalaccess::TwicISO7816Commands());
    }
}
...
getDESFireISO7816Commands(std::shared_ptr<logicalaccess::Commands> *commands)
{
    if (commands != NULL)
    {
        *commands = std::shared_ptr<logicalaccess::DESFireISO7816Commands>(
            new logicalaccess::DESFireISO7816Commands());
    }
}
...
getDESFireEV1ISO7816Commands(std::shared_ptr<logicalaccess::Commands> *commands)
{
    if (commands != NULL)
    {
        *commands = std::shared_ptr<logicalaccess::DESFireEV1ISO7816Commands>(
            new logicalaccess::DESFireEV1ISO7816Commands());
    }
}
