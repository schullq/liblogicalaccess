...
std::vector<unsigned char> ISO7816ISO7816Commands::readBinary(size_t length,
                                                              size_t offset, short efid)
{
...
void ISO7816ISO7816Commands::writeBinary(const std::vector<unsigned char> &data,
                                         size_t offset, short efid)
{
    unsigned char p1, p2;
...
void ISO7816ISO7816Commands::updateBinary(const std::vector<unsigned char> &data,
                                          size_t offset, short efid)
{
    unsigned char p1, p2;
...
std::vector<unsigned char> ISO7816ISO7816Commands::getData(size_t length,
...
void ISO7816ISO7816Commands::putData(const std::vector<unsigned char> &data,
                                     unsigned short dataObject)
{
    getISO7816ReaderCardAdapter()->sendAPDUCommand(
...
{
    getISO7816ReaderCardAdapter()->sendAPDUCommand(
        0x00, 0xA4, p1, p2, static_cast<unsigned char>(datalen),
        std::vector<unsigned char>(data, data + datalen));
}
}