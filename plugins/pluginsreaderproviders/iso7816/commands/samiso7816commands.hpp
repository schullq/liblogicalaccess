...
class LIBLOGICALACCESS_API SAMISO7816Commands : public virtual SAMCommands<T, S>
{
  public:
    ...
    virtual std::vector<unsigned char> decipherData(std::vector<unsigned char> data,
                                                    bool islastdata)
    {
    ...
    virtual std::vector<unsigned char> encipherData(std::vector<unsigned char> data,
                                                    bool islastdata)
    {
        unsigned char p1 = 0x00;
                            ...
                            unsigned char unlockkeyversion)
    {
        ...
        std::vector<unsigned char> keycipher(
            masterKey->getData(), masterKey->getData() + masterKey->getLength());
    ...
    changeKeyPICC(const ChangeKeyInfo &info,
  ...
  protected:
    ...
    void generateAuthEncKey(std::vector<unsigned char> keycipher,
