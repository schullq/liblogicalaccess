...
{
void ISO7816ReaderCardAdapter::sendAPDUCommand(const std::vector<unsigned char> &command,
...
std::vector<unsigned char> ISO7816ReaderCardAdapter::sendAPDUCommand(
    unsigned char cla, unsigned char ins, unsigned char p1, unsigned char p2,
    unsigned char lc, const std::vector<unsigned char> &data, unsigned char le)
{
...
std::vector<unsigned char> ISO7816ReaderCardAdapter::sendAPDUCommand(
    unsigned char cla, unsigned char ins, unsigned char p1, unsigned char p2,
    unsigned char lc, const std::vector<unsigned char> &data)
{
    std::vector<unsigned char> command;
    command.push_back(cla);
    command.push_back(ins);
...
std::vector<unsigned char> ISO7816ReaderCardAdapter::sendAPDUCommand(unsigned char cla,
                                                                     unsigned char ins,
                                                                     unsigned char p1,
                                                                     unsigned char p2,
                                                                     unsigned char le)
