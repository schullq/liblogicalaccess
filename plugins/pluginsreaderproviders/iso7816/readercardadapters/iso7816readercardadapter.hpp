...
class LIBLOGICALACCESS_API ISO7816ReaderCardAdapter : public ReaderCardAdapter
{
  public:
    ...
    */
    virtual void sendAPDUCommand(const std::vector<unsigned char> &command,
    ...
    sendAPDUCommand(unsigned char cla, unsigned char ins, unsigned char p1,
                    unsigned char p2, unsigned char lc,
                    const std::vector<unsigned char> &data, unsigned char le);
    ...
    virtual std::vector<unsigned char>
    sendAPDUCommand(unsigned char cla, unsigned char ins, unsigned char p1,
                    unsigned char p2, const std::vector<unsigned char> &data);
    ...
    virtual std::vector<unsigned char>
    sendAPDUCommand(unsigned char cla, unsigned char ins, unsigned char p1,
                    unsigned char p2, unsigned char lc, unsigned char le);

    /**
     * \brief Send an APDU command to the reader without data.
     */
    virtual std::vector<unsigned char> sendAPDUCommand(unsigned char cla,
                                                       unsigned char ins,
