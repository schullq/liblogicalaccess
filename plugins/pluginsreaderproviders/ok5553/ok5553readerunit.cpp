    ...
    : ReaderUnit(READER_OK5553)
{
    ...
    setDefaultReaderCardAdapter(
        std::shared_ptr<OK5553ReaderCardAdapter>(new OK5553ReaderCardAdapter()));
...
OK5553ReaderUnit::asciiToHex(const std::vector<unsigned char> &source)
{
...
std::vector<unsigned char> OK5553ReaderUnit::reqA()
{
    std::vector<unsigned char> answer =
        getDefaultOK5553ReaderCardAdapter()->sendAsciiCommand("t01E326");
