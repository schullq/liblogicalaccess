...
std::vector<unsigned char> ISO7816OK5553ReaderCardAdapter::sendAPDUCommand(
...
ISO7816OK5553ReaderCardAdapter::adaptCommand(const std::vector<unsigned char> &command)
{
    char tmp[3];
...
std::vector<unsigned char>
ISO7816OK5553ReaderCardAdapter::adaptAnswer(const std::vector<unsigned char> &answer)
{
...
std::vector<unsigned char>
ISO7816OK5553ReaderCardAdapter::answerReverse(const std::vector<unsigned char> &answer)
{
...
std::vector<unsigned char>
ISO7816OK5553ReaderCardAdapter::handleAnswer(const std::vector<unsigned char> &answer)
{
