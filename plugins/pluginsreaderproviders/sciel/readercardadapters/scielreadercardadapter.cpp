...
SCIELReaderCardAdapter::adaptCommand(const std::vector<unsigned char> &command)
{
...
std::vector<unsigned char>
SCIELReaderCardAdapter::adaptAnswer(const std::vector<unsigned char> &answer)
{
...
SCIELReaderCardAdapter::receiveTagsListCommand(const std::vector<unsigned char> &command,
                                               long int timeout)
{
    LOG(LogLevel::COMS)
