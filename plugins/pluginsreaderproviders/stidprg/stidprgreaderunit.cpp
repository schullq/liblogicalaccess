...
#include "readercardadapters/stidprgbufferparser.hpp"
#include "readercardadapters/stidprgdatatransport.hpp"
...
STidPRGReaderUnit::getSTidPRGReaderUnitConfiguration()
{
