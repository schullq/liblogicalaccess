...
AdmittoReaderCardAdapter::adaptCommand(const std::vector<unsigned char> &command)
{
    return command;
}

std::vector<unsigned char>
AdmittoReaderCardAdapter::adaptAnswer(const std::vector<unsigned char> &answer)
{
