...
GigaTMSReaderCardAdapter::adaptCommand(const std::vector<unsigned char> &command)
{
...
std::vector<unsigned char>
GigaTMSReaderCardAdapter::adaptAnswer(const std::vector<unsigned char> &answer)
{
