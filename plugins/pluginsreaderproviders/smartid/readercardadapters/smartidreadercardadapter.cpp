...
void SmartIDReaderCardAdapter::sendAPDUCommand(const std::vector<unsigned char> &command,
...
std::vector<unsigned char> SmartIDReaderCardAdapter::sendCommand(
    unsigned char cmd, const std::vector<unsigned char> &command, long int timeout)
{
...
SmartIDReaderCardAdapter::adaptCommand(const std::vector<unsigned char> &command)
{
...
std::vector<unsigned char>
SmartIDReaderCardAdapter::adaptAnswer(const std::vector<unsigned char> &answer)
{
    ...
    std::vector<unsigned char> buf = std::vector<unsigned char>(
        answer.begin() + 4 + ((len == DLE) ? 1 : 0), answer.end());
