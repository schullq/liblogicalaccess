...
class LIBLOGICALACCESS_API SmartIDReaderProvider : public ReaderProvider
{
  public:
    /**
     * \brief Get the SmartIDReaderProvider instance. Singleton because we can only have
     * one COM communication, and the SmartID can't have shared access, so we share the
     * same reader unit.
     */
