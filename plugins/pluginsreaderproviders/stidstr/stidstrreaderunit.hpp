...
class LIBLOGICALACCESS_API STidSTRReaderUnit : public ReaderUnit
{
  public:
    ...
    authenticateReader2(const std::vector<unsigned char> &data);
     ...
     */
    void ChangeReaderKeys(const std::vector<unsigned char> &key_hmac,
     ...
     */
    std::vector<unsigned char> getSessionKeyHMAC() const
    {
     ...
     * \return The session key.
     */
    std::vector<unsigned char> getSessionKeyAES() const
    {
