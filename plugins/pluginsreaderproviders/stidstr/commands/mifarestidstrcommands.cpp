...
std::vector<unsigned char> MifareSTidSTRCommands::scanMifare()
{
    ...
    std::vector<unsigned char> r =
        getSTidSTRReaderCardAdapter()->sendCommand(0x00A0, std::vector<unsigned char>());
...
std::vector<unsigned char> MifareSTidSTRCommands::readBinary(unsigned char blockno,
                                                             size_t len)
{
    ...
    std::vector<unsigned char> sbuf =
        getSTidSTRReaderCardAdapter()->sendCommand(0x00B2, command);
...
std::vector<unsigned char> MifareSTidSTRCommands::readBinaryIndex(unsigned char keyindex,
                                                                  ...
                                                                  size_t /*len*/)
{
    ...
    std::vector<unsigned char> sbuf =
        getSTidSTRReaderCardAdapter()->sendCommand(0x00B1, command);
...
void MifareSTidSTRCommands::updateBinary(unsigned char blockno,
