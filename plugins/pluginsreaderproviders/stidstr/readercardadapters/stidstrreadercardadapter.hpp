...
class LIBLOGICALACCESS_API STidSTRReaderCardAdapter : public ReaderCardAdapter
{
  public:
     ...
     */
    virtual std::vector<unsigned char>
    sendCommand(unsigned short commandCode, const std::vector<unsigned char> &command,
  ...
  protected:
     ...
     */
    std::vector<unsigned char> sendMessage(unsigned short commandCode,
     ...
     */
    std::vector<unsigned char> receiveMessage(const std::vector<unsigned char> &data,
