...
*/
class LIBLOGICALACCESS_API FeliCaSpringCardCommands : public virtual FeliCaCommands
{
  public:
    /**
    * \brief Constructor.
    ...
    */
    ...
    requestServices(const std::vector<unsigned short> &codes);
    ...
    * \return Data read.
    */
    virtual std::vector<unsigned char> read(const std::vector<unsigned short> &codes,
