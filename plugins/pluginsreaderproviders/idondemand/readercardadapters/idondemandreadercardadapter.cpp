...
IdOnDemandReaderCardAdapter::adaptCommand(const std::vector<unsigned char> &command)
{
...
std::vector<unsigned char>
IdOnDemandReaderCardAdapter::adaptAnswer(const std::vector<unsigned char> &answer)
{
