...
{
  public:
    OSDPSecureChannel(std::vector<unsigned char> uid,
                      std::vector<unsigned char> PDChallenge,
                      std::vector<unsigned char> PDCryptogram,
                      std::vector<unsigned char> CPChallenge)
        : isSCBK_D(false)
        , m_uid(uid)
    ...
    std::vector<unsigned char> computeMAC(std::vector<unsigned char> data,
                                          openssl::AESInitializationVector iv);

    std::vector<unsigned char> computePacketMAC(std::vector<unsigned char> data);

    std::vector<unsigned char> encryptData(std::vector<unsigned char> data,
                                           std::vector<unsigned char> iv);

    std::vector<unsigned char> decryptData(std::vector<unsigned char> data,
                                           std::vector<unsigned char> iv);
    ...
    std::vector<unsigned char> &getPDChallenge()
    {
        return m_PDChallenge;
    }

    std::vector<unsigned char> &getPDCryptogram()
    {
        return m_PDCryptogram;
    }

    std::vector<unsigned char> &getCPChallenge()
    {
        return m_CPChallenge;
    }

    std::vector<unsigned char> &getCPCryptogram()
    {
        return m_CPCryptogram;
    }

    std::vector<unsigned char> &getSMAC1()
    {
        return m_smac1;
    }

    void setSMAC1(std::vector<unsigned char> smac1)
    {
        m_smac1 = smac1;
    }

    std::vector<unsigned char> &getSMAC2()
    {
        return m_smac2;
    }

    void setSMAC2(std::vector<unsigned char> smac2)
    {
        m_smac2 = smac2;
    }

    std::vector<unsigned char> &getSENC()
    {
        return m_senc;
    }

    void setSENC(std::vector<unsigned char> senc)
    {
        m_senc = senc;
    }

    std::vector<unsigned char> &getRMAC()
    {
        return m_rmac;
    }

    void setRMAC(std::vector<unsigned char> rmac)
    {
        m_rmac = rmac;
    }

    std::vector<unsigned char> &getCMAC()
    {
        return m_cmac;
    }

    void setCMAC(std::vector<unsigned char> cmac)
    {
        m_cmac = cmac;
    }
