                                  ...
                                  std::shared_ptr<AES128Key> scbkdkey)
{
    ...
    openssl::SymmetricKey aeskey =
        openssl::AESSymmetricKey(openssl::AESSymmetricKey::createFromData(
            std::vector<unsigned char>(keydata, keydata + 16)));
...
void OSDPSecureChannel::computeAuthenticationData()
{
    ...
    if (!std::equal(encCryptogramInput.begin(), encCryptogramInput.end(),
...
OSDPSecureChannel::computeMAC(std::vector<unsigned char> data,
...
std::vector<unsigned char>
OSDPSecureChannel::computePacketMAC(std::vector<unsigned char> data)
{
...
void OSDPSecureChannel::verifyMAC(std::vector<unsigned char> data)
{
    ...
    mac         = computeMAC(std::vector<unsigned char>(data.begin(), data.end() - 4),
...
std::vector<unsigned char>
OSDPSecureChannel::encryptData(std::vector<unsigned char> data,
                               std::vector<unsigned char> ivArray)
{
...
std::vector<unsigned char>
OSDPSecureChannel::decryptData(std::vector<unsigned char> data,
                               std::vector<unsigned char> ivArray)
{
