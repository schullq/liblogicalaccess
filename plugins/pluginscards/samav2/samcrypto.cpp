...
SAMDESfireCrypto::authenticateHostP1(std::shared_ptr<DESFireKey> key,
...
void SAMDESfireCrypto::authenticateHostP2(unsigned char keyno,
...
std::vector<unsigned char>
SAMDESfireCrypto::sam_crc_encrypt(std::vector<unsigned char> d_sessionKey,
