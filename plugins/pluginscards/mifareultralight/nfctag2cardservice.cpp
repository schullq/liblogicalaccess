...
{
    std::shared_ptr<logicalaccess::MifareUltralightCommands> mfucmd(
...
void NFCTag2CardService::writeNDEF(std::shared_ptr<logicalaccess::NdefMessage> records)
{
    ...
    std::shared_ptr<logicalaccess::MifareUltralightLocation> location(
        new logicalaccess::MifareUltralightLocation());
    location->page = 4;
