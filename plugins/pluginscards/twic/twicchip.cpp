...
std::shared_ptr<LocationNode> TwicChip::getRootLocationNode()
{
    ...
    ucuiNode->setLength(
        getTwicCommands()->getDataObjectLength(ucuiLocation->dataObject, true));
    ...
    tpkNode->setLength(
        getTwicCommands()->getDataObjectLength(tpkLocation->dataObject, true));
    ...
    cuiNode->setLength(
        getTwicCommands()->getDataObjectLength(cuiLocation->dataObject, true));
    ...
    cfNode->setLength(
        getTwicCommands()->getDataObjectLength(cfLocation->dataObject, true));
    ...
    soNode->setLength(
        getTwicCommands()->getDataObjectLength(soLocation->dataObject, true));
