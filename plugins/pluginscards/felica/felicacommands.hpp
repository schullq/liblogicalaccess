...
class LIBLOGICALACCESS_API FeliCaCommands : public Commands
{
  public:
    ...
    */
    ...
    virtual std::vector<unsigned char> read(unsigned short code,
    ...
    */
    ...
    read(const std::vector<unsigned short> &codes,
    ...
    virtual void write(unsigned short code, unsigned short block,
                       const std::vector<unsigned char> &data);
