...
class LIBLOGICALACCESS_API ISO7816Commands : public virtual Commands
{
  public:
     ...
     */
    virtual std::vector<unsigned char> readBinary(size_t length, size_t offset,
                                                  short efid = 0) = 0;
     ...
     * \return True on success, false otherwise.
     */
    virtual void writeBinary(const std::vector<unsigned char> &data, size_t offset,
                             short efid = 0) = 0;
     ...
     * \return True on success, false otherwise.
     */
    virtual void updateBinary(const std::vector<unsigned char> &data, size_t offset,
                              short efid = 0) = 0;
     ...
     * \return True on success, false otherwise.
     */
    virtual std::vector<unsigned char> getData(size_t length,
                                               unsigned short dataObject) = 0;
     ...
     * \return True on success, false otherwise.
     */
    virtual void putData(const std::vector<unsigned char> &data,
                         unsigned short dataObject) = 0;
