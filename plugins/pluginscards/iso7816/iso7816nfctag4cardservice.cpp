...
{
    std::shared_ptr<logicalaccess::ISO7816Commands> iso7816command(
        std::dynamic_pointer_cast<logicalaccess::ISO7816Commands>(
            getChip()->getCommands()));
...
void ISO7816NFCTag4CardService::writeNDEFFile(std::vector<unsigned char> recordsData,
                                              unsigned short isoFIDNDEFFile)
{
    std::shared_ptr<logicalaccess::ISO7816Commands> iso7816command(
        std::dynamic_pointer_cast<logicalaccess::ISO7816Commands>(
...
void ISO7816NFCTag4CardService::writeNDEFFile(
    std::shared_ptr<logicalaccess::NdefMessage> records, unsigned short isoFIDNDEFFile)
{
