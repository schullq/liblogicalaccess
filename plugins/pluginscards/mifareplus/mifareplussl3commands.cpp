...
ByteVector MifarePlusSL3Commands_NEW::readBinaryPlain(unsigned char blockno, size_t len)
{
    assert(len / 16 < 255);
    ...
    data = {0x32, 0x14, 0xA5, 0xF4, 0xDE, 0x18, 0xAE, 0xC8,
            0xDA, 0x6F, 0x50, 0x33, 0x32, 0xB7, 0x10, 0xD7};
