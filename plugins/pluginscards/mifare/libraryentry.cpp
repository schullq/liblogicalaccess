...
LIBLOGICALACCESS_API void getMifare1KChip(std::shared_ptr<logicalaccess::Chip> *chip)
{
    if (chip != NULL)
    {
        *chip = std::shared_ptr<logicalaccess::Mifare1KChip>(
            new logicalaccess::Mifare1KChip());
    }
}
...
LIBLOGICALACCESS_API void getMifare4KChip(std::shared_ptr<logicalaccess::Chip> *chip)
{
    if (chip != NULL)
    {
        *chip = std::shared_ptr<logicalaccess::Mifare4KChip>(
            new logicalaccess::Mifare4KChip());
    }
}
...
LIBLOGICALACCESS_API void getMifareChip(std::shared_ptr<logicalaccess::Chip> *chip)
{
    ...
    {
        *chip =
            std::shared_ptr<logicalaccess::MifareChip>(new logicalaccess::MifareChip());
    }
}
