...
class LIBLOGICALACCESS_API MifareCommands : public virtual Commands
{
  public:
    ...
    readSector(int sector, int start_block, std::shared_ptr<MifareKey> keyA,
               std::shared_ptr<MifareKey> keyB,
               const MifareAccessInfo::SectorAccessBits &sab,
               bool readtrailer = false) final;

    virtual void
    writeSector(int sector, int start_block, const std::vector<unsigned char> &buf,
    ...
    virtual std::vector<unsigned char>
    readSectors(int start_sector, int stop_sector, int start_block,
                std::shared_ptr<MifareKey> keyA, std::shared_ptr<MifareKey> keyB,
    ...
    virtual void writeSectors(
        ...
        unsigned char userbyte = 0x00, MifareAccessInfo::SectorAccessBits *newsab = NULL,
        std::shared_ptr<MifareKey> newkeyA = std::shared_ptr<MifareKey>(),
        std::shared_ptr<MifareKey> newkeyB = std::shared_ptr<MifareKey>()) final;
    ...
    MifareKeyType getKeyType(const MifareAccessInfo::SectorAccessBits &sab, int sector,
