...
{
void SagemKeyDiversification::initDiversification(std::vector<unsigned char> identifier,
                                                  int /*AID*/,
...
SagemKeyDiversification::getDiversifiedKey(std::shared_ptr<Key> key,
                                           std::vector<unsigned char> diversify)
{
    LOG(LogLevel::INFOS) << "Using key diversification Sagem with div : "
