 ...
 */
typedef enum { CM_LEGACY = 0x00, CM_ISO = 0x01 } CryptoMethod;
...
class LIBLOGICALACCESS_API DESFireCrypto
{
  public:
     ...
     */
    std::vector<unsigned char> desfireEncrypt(
    ...
    encipherData(bool end, std::vector<unsigned char> data,
                 const std::vector<unsigned char> &param = std::vector<unsigned char>());

    std::vector<unsigned char> iso_encipherData(
        bool end, const std::vector<unsigned char> &data,
        const std::vector<unsigned char> &param = std::vector<unsigned char>());
    ...
    desfire_CBC_send(const std::vector<unsigned char> &key,
     ...
     */
    static std::vector<unsigned char>
    desfire_CBC_receive(const std::vector<unsigned char> &key,
                        const std::vector<unsigned char> &iv,
                        const std::vector<unsigned char> &data);
     ...
     */
    static std::vector<unsigned char>
    desfire_CBC_mac(const std::vector<unsigned char> &key,
                    const std::vector<unsigned char> &iv,
                    const std::vector<unsigned char> &data);
     ...
     */
    static std::vector<unsigned char>
    sam_CBC_send(const std::vector<unsigned char> &key,
                 const std::vector<unsigned char> &iv,
                 const std::vector<unsigned char> &data);
     ...
     */
    std::vector<unsigned char> desfire_mac(const std::vector<unsigned char> &key,
     ...
     */
    static std::vector<unsigned char>
    desfire_encrypt(const std::vector<unsigned char> &key,
                    std::vector<unsigned char> data);
     ...
     * \return The data encrypted buffer
     */
    std::vector<unsigned char> desfire_iso_encrypt(
     ...
     * \return The data encrypted buffer
     */
    std::vector<unsigned char> sam_encrypt(const std::vector<unsigned char> &key,
                                           std::vector<unsigned char> data);
     ...
     */
    std::vector<unsigned char> desfire_decrypt(const std::vector<unsigned char> &key,
                                               const std::vector<unsigned char> &data,
                                               size_t datalen);
     ...
     */
    std::vector<unsigned char>
    desfire_iso_decrypt(const std::vector<unsigned char> &key,
                        const std::vector<unsigned char> &data,
     ...
     * \return The data decrypted buffer
     */
    std::vector<unsigned char> desfire_iso_decrypt(const std::vector<unsigned char> &data,
                                                   size_t length);
     ...
     */
    std::vector<unsigned char>
    desfire_cmac(const std::vector<unsigned char> &key,
                 std::shared_ptr<openssl::OpenSSLSymmetricCipher> cipherMAC,
                 unsigned int block_size, const std::vector<unsigned char> &data);
    ...
    authenticate_PICC1(unsigned char keyno, std::vector<unsigned char> diversify,
     ...
     */
    virtual void authenticate_PICC2(unsigned char keyno,
                                    const std::vector<unsigned char> &encRndA);
     ...
     */
    std::vector<unsigned char>
    iso_authenticate_PICC1(unsigned char keyno, std::vector<unsigned char> diversify,
                           const std::vector<unsigned char> &encRndB,
     ...
     * \param randomlen The random length
     */
    void iso_authenticate_PICC2(unsigned char keyno,
     ...
     */
    std::vector<unsigned char>
    aes_authenticate_PICC1(unsigned char keyno, std::vector<unsigned char> diversify,
                           const std::vector<unsigned char> &encRndB);
     ...
     * \param encRndA The encrypted random number A
     */
    void aes_authenticate_PICC2(unsigned char keyno,
                                const std::vector<unsigned char> &encRndA1);
     ...
     */
    static void getKey(std::shared_ptr<DESFireKey> key,
     ...
     */
    std::vector<unsigned char> changeKey_PICC(unsigned char keyno,
    ...
    void setIdentifier(std::vector<unsigned char> identifier)
    {
  ...
  protected:
    ...
    * \return True on success, false otherwise.
    */
    bool getKey(size_t aid, unsigned char keyno, std::vector<unsigned char> diversify,
                std::vector<unsigned char> &keydiv);
    ...
    * \return True on success, false otherwise.
    */
    bool getKey(unsigned char keyno, std::vector<unsigned char> diversify,
                std::vector<unsigned char> &keydiv);
