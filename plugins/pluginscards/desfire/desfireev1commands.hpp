...
class LIBLOGICALACCESS_API DESFireEV1Commands : public virtual DESFireCommands
{
  public:
    ...
    virtual void createApplication(
        ...
        std::vector<unsigned char> isoDFName = std::vector<unsigned char>()) = 0;
    ...
    virtual void iso_externalAuthenticate(
        ...
        const std::vector<unsigned char> &data = std::vector<unsigned char>()) = 0;
    ...
    virtual void iso_selectApplication(
        std::vector<unsigned char> isoaid = std::vector<unsigned char>(
            DFEV1_DESFIRE_AID, DFEV1_DESFIRE_AID + sizeof(DFEV1_DESFIRE_AID))) = 0;
