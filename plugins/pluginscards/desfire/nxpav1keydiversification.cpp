...
{
void NXPAV1KeyDiversification::initDiversification(std::vector<unsigned char> identifier,
...
NXPAV1KeyDiversification::getDiversifiedKey(std::shared_ptr<Key> key,
                                            std::vector<unsigned char> diversify)
{
